...
final class WorkflowCommandRegressionTests: XCTestCase {
    ...
    func testSubcommands() {
        ...
        XCTAssertEqual(subcommands, ["run", "builder-run", "template", "list", "validate", "diff"])
    }
...
final class DbCommandRegressionTests: XCTestCase {
    ...
    func testSubcommands() {
        ...
        XCTAssertTrue(subs.contains { $0 == DbCommand.DbUpdateSubcommand.self })
        XCTAssertTrue(subs.contains { $0 == DbCommand.DbInstallManagedSubcommand.self })
    }
}
