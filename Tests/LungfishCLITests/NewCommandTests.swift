...
final class SubcommandRegistrationTests: XCTestCase {
    ...
    func testTotalSubcommandCount() throws {
        let config = LungfishCLI.configuration
        // 44 subcommands: version, convert, analyze, translate, sequence, search, universal-search,
        ...
        // markdup, primers, genotype, haplotypes, tools, debug.
        XCTAssertEqual(config.subcommands.count, 44)
    }
