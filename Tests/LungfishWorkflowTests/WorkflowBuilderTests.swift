...
final class WorkflowBuilderTests: XCTestCase {
    ...
    func testWorkflowDiffReportsVersionNodeAndParameterChanges() throws {
        ...
        _ = try original.addConnection(sourceNodeId: input.id, sourcePortId: "reads", targetNodeId: trim.id, targetPortId: "reads")
        ...
        let text = WorkflowGraphDiff.compare(original, revised).textDescription
