...
final class GUIRegressionTests: XCTestCase {
    ...
    func testONTImportOperationShowsAvailableCLICommand() throws {
        ...
        XCTAssertTrue(mainSplitSource.contains("recipeOptions: [.ontFluidigmSampleSplit, .ontPacBioBarcodeDemux]"))
        ...
        XCTAssertTrue(mainSplitSource.contains("config.recipeName == FASTQImportSheetRecipeOption.ontPacBioBarcodeDemux.id"))
