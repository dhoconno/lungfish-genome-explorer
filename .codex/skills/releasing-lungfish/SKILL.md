...
6. `dependencySet` in the manifest equals the receipt from `scripts/deps/verify.sh`; a green `toolset-conformance` run exists for the manifest hash. See `docs/release/dependency-sweep.md`.
