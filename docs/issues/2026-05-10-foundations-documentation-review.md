...
| FND-029 | P2 | `docs/issues/2026-05-09-followups-from-evaluation-sweep.md:57` | Resolved 2026-07-04: the active issue status now says Workflow Builder is a reachable experimental feature. | Not directly a Foundations prose bug, but it affected planning confidence for documentation follow-up work. | No further action for this row; continue verifying active issue status before implementation sprint planning. |
