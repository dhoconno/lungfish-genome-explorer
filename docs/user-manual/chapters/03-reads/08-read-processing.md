...
Open the Human Reads demo project with **Help > Demo Projects…**, as [Demo projects](../01-foundations/06-the-lungfish-project.md#demo-projects) explains. It already holds everything this section imports, the `HG002.chr20.10.0-10.5Mb` bundle, the `HG002.chrM.ont` bundle, and the `NC_012920.1` reference. To import the files yourself instead, follow the rest of this section.
