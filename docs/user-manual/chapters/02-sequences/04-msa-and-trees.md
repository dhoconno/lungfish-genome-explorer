...
![Three short sequences before and after gap insertion so homologous bases share columns](../../assets/illustrations-imagegen/02-sequences/04-msa-and-trees/msa-column-homology.source.png)
...
![Rectangular phylogram with tips, internal nodes, branch lengths, and bootstrap support values](../../assets/illustrations-imagegen/02-sequences/04-msa-and-trees/tree-anatomy.source.png)
