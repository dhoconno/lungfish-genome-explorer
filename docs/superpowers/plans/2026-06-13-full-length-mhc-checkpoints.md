...
- [ ] **Step 1: Write failing parser/argv tests**
...
- [ ] **Step 2: Run parser/argv tests to verify failure**
...
- [ ] **Step 1: Write failing workflow reuse test**
...
- [ ] **Step 3: Implement checkpoint manifests**
...
- [ ] **Step 4: Run the single test to verify pass**
...
- [ ] **Step 1: Add cleanup/provenance assertions**
...
- [ ] **Step 2: Implement cleanup and signature guard refinements**
