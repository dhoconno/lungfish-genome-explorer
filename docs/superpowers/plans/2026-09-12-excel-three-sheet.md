...
- [ ] Adapt filtered captured rows/cell masks and annotations to the shared payload, replacing only its clean-presentation section. Old no-projection CLI compatibility remains tested. Do not reconstruct visible cells from row membership alone.
