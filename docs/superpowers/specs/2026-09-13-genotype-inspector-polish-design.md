...
1. Hide the bottom detail pane for positively identified MiSeq MHC results in Genotype Matrix, regardless of selection. This includes typed MiSeq genotype-only results. Keep other workflows and Haplotype Calls evidence behavior intact.
