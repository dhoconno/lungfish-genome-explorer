...
| `PhylogeneticTreeViewController.swift` | Selected-node detail and Nodes drawer title | Primary detail content | Detail/table-header roles; unlimited detail wrapping, a canvas-reserved detail region, and a content-measured drawer height. |
