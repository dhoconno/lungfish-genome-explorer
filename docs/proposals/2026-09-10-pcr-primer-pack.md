...
2026-09-11 follow-up: the user approved a publicly distributed, explicitly identified PrimalScheme3-LGE custom fork. See `docs/features/primalscheme3-lge-fork.md` for the missing-data policy, backend distinction and pinned dependency contract. Earlier implementation plans and stock validation results describe the initial implementation.
