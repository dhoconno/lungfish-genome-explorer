...
- 2026-07-05 follow-up: Plugin Manager storage/progress callbacks now use the established
  main-queue `MainActor.assumeIsolated` bridge, and MainSplit split-extension headers now name
  their actual files/responsibilities instead of the stale monolithic controller header.
