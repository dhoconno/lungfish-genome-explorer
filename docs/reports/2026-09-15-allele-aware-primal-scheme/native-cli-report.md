...
- Latest integrated LGE focused run: **144 passed**, seven environment-gated tests skipped, zero failures (151 total). The real A1 integration was run separately with its environment enabled: one passed in 251.64 seconds, including all 1,380 real four-site certificates, stored-bundle inspection/history and a fresh relocated raw-row audit.
