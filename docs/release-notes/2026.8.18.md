...
Previous versioned release: v2026.8.17

Stable baseline: v2026.8.13

Dependency set: 2026.2

Lungfish 2026.8.18 is a preview release that carries forward the portable,
side-by-side Debug, Preview, and Stable release profiles while making the
exact-tag GitHub release gate reliable on clean runners.

v2026.8.15, v2026.8.16, and v2026.8.17 were prepared and tagged during
release-process validation but were not published as GitHub releases or Sparkle
updates. This release supersedes those unpublished preparations.
...
a one-time manual installation from the 2026.8.18 Preview DMG rather than an
...
run on separate GitHub machines. Source-test jobs now restore the exact
