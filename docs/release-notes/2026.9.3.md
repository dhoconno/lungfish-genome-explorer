...
Previous versioned release: v2026.9.2

Stable baseline: v2026.8.13

Dependency set: 2026.2

Lungfish 2026.9.3 promotes the work validated in published previews
...
v2026.9.2 was also tagged but not published after its exact-tag Stable
conformance runner exposed a missing dependency-cache handoff. The runner now
restores and verifies the exact manifest-keyed cache before seeding and
independently verifying its isolated conformance root.
...
by the dependency job. Stable conformance seeds a separate root from that
verified handoff, reconciles it against the manifest, and verifies a fresh
isolated receipt. Post-publication verification resolves project-relative
