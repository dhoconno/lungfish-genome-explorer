...
public actor BigBedReader {
    ...
    private func readFeaturesFromIndex(chromId: UInt32, chromName: String, start: UInt32, end: UInt32) throws -> [BigBedFeature] {
        ...
        _ = rTreeHeader.withUnsafeBytes { $0.loadUnaligned(fromByteOffset: 28, as: UInt32.self) }  // endBase
        _ = rTreeHeader.withUnsafeBytes { $0.loadUnaligned(fromByteOffset: 32, as: UInt64.self) }  // fileSize
        _ = rTreeHeader.withUnsafeBytes { $0.loadUnaligned(fromByteOffset: 40, as: UInt32.self) }  // itemsPerSlot
