...
enum FASTQOperationToolID: String, CaseIterable, Sendable {
    ...
    var title: String {
        ...
        case .ontGenotyping: return "Amplicon Genotyping"
    ...
    var subtitle: String {
        ...
        case .ontGenotyping: return "Run exact+indel amplicon genotyping for ONT barcode-demux or prepared Illumina sample bundles and write one Excel genotype report."
